...
from .views import PlayedTournamentsView, PendingTournamentsView, TournamentMenuView, CurrentUserView, CreateTournamentView, DeleteTournamentView, StartTournamentView, StartMatchView, TournamentMatchesView, DetermineTournamentWinnerView, TournamentDetailView
